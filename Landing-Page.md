...
**Startup:** ~1 second. No vector DB, no embedding model, no separate daemon. Just `pip install codetree`.
...
| **LSP servers** | Heavyweight, stateful, language-specific setup | One `pip install`, 10 languages, stateless MCP |
